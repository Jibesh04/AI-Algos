...
void main(){
	...
	setaxes();
	pointout(0, 0, 14);
	// line(midx + goal -> x, midy - (goal -> y), midx + goal -> x, midy - (goal -> y));
	// circle(goal -> x, goal -> y, 1);
	pointout(15, 20, 2);
...
// 	int x = node -> x;
// 	int y = node -> y;
// 	if(0 < x && x < 15 && 0 < y && y < 20) return 2;
// 	if(0 < x && x < 15 || 0 < y && y < 20) return 4;
// 	if(x == 0 && y == 0 || x == 15 && y == 20) return 10;
// 	if(x == 0 && y == 20 || x == 15 && y == 0) return 8;
// 	return 20;
// }
